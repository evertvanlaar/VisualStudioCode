// service-worker.js
const VERSION = '1.0.52'; // Dit sturen we naar de Sheet
const CACHE_NAME = 'kalanera-cache-v1.0.152'; // Dit dwingt de code-update af
const IMAGE_CACHE = 'kalanera-images-v152'; // Dit laten we lekker staan voor de snelheid
