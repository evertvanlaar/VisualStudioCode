// service-worker.js
const VERSION = '2.0.85'; // Dit sturen we naar de Sheet
const CACHE_NAME = 'kalanera-cache-v2.0.85'; // Dit dwingt de code-update af
const IMAGE_CACHE = 'kalanera-images-v2.0.85'; // Afbeeldingen apart cachen voor snelheid
