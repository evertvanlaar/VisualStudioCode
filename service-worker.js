// service-worker.js
const VERSION = '1.0.112'; // Dit sturen we naar de Sheet
const CACHE_NAME = 'kalanera-cache-v1.0.112'; // Dit dwingt de code-update af
const IMAGE_CACHE = 'kalanera-images-v1.0.112'; // Afbeeldingen apart cachen voor snelheid
