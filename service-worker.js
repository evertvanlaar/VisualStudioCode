// service-worker.js
const VERSION = '2.0.86'; // Dit sturen we naar de Sheet
const CACHE_NAME = 'kalanera-cache-v2.0.86'; // Dit dwingt de code-update af
const IMAGE_CACHE = 'kalanera-images-v2.0.86'; // Afbeeldingen apart cachen voor snelheid
