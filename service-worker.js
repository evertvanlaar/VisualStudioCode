// service-worker.js
const VERSION = '2.1.101'; // Dit sturen we naar de Sheet
const CACHE_NAME = 'kalanera-cache-v2.1.101'; // Dit dwingt de code-update af
const IMAGE_CACHE = 'kalanera-images-v2.1.101'; // Afbeeldingen apart cachen voor snelheid
