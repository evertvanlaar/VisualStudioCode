// service-worker.js
const VERSION = '3.1.55'; // Dit sturen we naar de Sheet
const CACHE_NAME = 'kalanera-cache-v3.1.55'; // Dit dwingt de code-update af
const IMAGE_CACHE = 'kalanera-images-v3.1.55'; // Afbeeldingen apart cachen voor snelheid
