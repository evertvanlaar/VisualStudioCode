// service-worker.js
const VERSION = '1.0.60'; // Dit sturen we naar de Sheet
const CACHE_NAME = 'kalanera-cache-v1.0.160'; // Dit dwingt de code-update af
const IMAGE_CACHE = 'kalanera-images-v160'; // Dit laten we lekker staan voor de snelheid
