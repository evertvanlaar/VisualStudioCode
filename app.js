...
/* --- PREMIUM DARK MODE OPTIMALISATIE --- */
[data-theme="dark"] {
    --bg: #121212;            /* Iets zachter dan puur zwart */
    --card: #1e1e1e;          /* Donkergrijze kaarten */
    --text: #e0e0e0;          /* Gebroken wit voor minder fel licht */
    --border: #333333;        /* Subtiele randen */
    --pill: #2a2a2a;          /* Donkere knoppen */
}

/* 1. De Categorie Koppen (nu nog te wit op je foto) */
[data-theme="dark"] .category-section-header {
    background: #1e1e1e !important; 
    color: #ffffff !important;
    border-left: 5px solid var(--primary-olive);
    box-shadow: none;
}

[data-theme="dark"] .category-section-header small {
    background: #333 !important;
    color: var(--primary-olive);
}

/* 2. De Filter Buttons (die nu nog grijs/wit zijn) */
...
/* 4. De Kaarten (Business Cards) */
[data-theme="dark"] .biz-card-mini {
    background: #1e1e1e !important;
...
/* 5. De Google Maps kaart verzachten */
...
[data-theme="dark"] .logo, [data-theme="dark"] .nav-links a {
    color: white !important;
}